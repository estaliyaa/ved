...
// Быстрые действия после ответа — формулируем глаголами («Посмотреть…», «Рассчитать…»).
const FOLLOWUPS: Record<string, string[]> = {
  tracking: [
    "Рассчитать платежи по грузу",
    "Подобрать документы для груза",
    "Узнать дату прибытия",
  ],
  company: [
    "Показать импорт компании",
    "Оценить риски контрагента",
    "Найти связанные компании",
  ],
  documents: [
    "Рассчитать платежи",
    "Проверить ограничения",
    "Подобрать разрешительные документы",
  ],
  restrictions: [
    "Проверить ограничения на экспорт",
    "Показать санкционные списки",
...
/** Сценарии по клику на карточку раздела — ИИ ведёт диалог сам. */
const FLOWS: Record<string, { guide: string; actions: string[] }> = {
  "product-analysis": {
    guide:
      "Давайте начнём с анализа товара. Введите код ТН ВЭД или название товара — подберу код, пошлины, ограничения и статистику.",
    actions: [
      "Подобрать код ТН ВЭД",
      "Показать пошлины и налоги",
      "Проверить ограничения",
      "Посмотреть рейтинг продавцов",
    ],
  },
  "importer-map": {
    guide:
      "Разберём импортную сделку шаг за шагом. С какого товара начнём — введите код ТН ВЭД или наименование.",
    actions: [
      "Рассчитать платежи",
      "Подобрать документы",
  ...
  "importer-check": {
    guide:
      "Давайте проверим контрагента. Введите БИН или название компании — покажу реквизиты, ВЭД-активность и риски.",
    actions: [
      "Проверить надёжность компании",
      "Показать ВЭД-активность",
      "Найти связанные компании",
      "Оценить риски",
    ],
  },
  calculator: {
    guide:
      "Рассчитаю таможенные платежи. Укажите товар, его стоимость и количество.",
    actions: [
      "Рассчитать платежи",
      "Объяснить расчёт",
      "Снизить платежи",
  ...
  "customs-infrastructure": {
    guide:
      "Помогу с околотаможенной инфраструктурой. Что ищем — СВХ, склад, пост или представителя?",
    actions: [
      "Найти ближайший СВХ",
      "Сравнить тарифы складов",
      "Показать таможенные посты",
      "Найти представителя",
    ],
  },
  "container-tracking": {
    guide:
      "Отслежу контейнер. Введите номер контейнера — покажу маршрут, порты, статусы и дату прибытия.",
    actions: [
      "Отследить контейнер",
      "Показать маршрут и порты",
      "Узнать дату прибытия",
      "Рассчитать платежи по грузу",
    ],
  },
...
export function useAssistant({
  ...
  // Клик по карточке раздела: ИИ открывает диалог и сам предлагает шаги.
  const startCardFlow = useCallback(
    (moduleId: string) => {
