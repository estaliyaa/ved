...
function buildExportRef(p: ProductSummary): CustomsSection[] {
  ...
  return [
    ...
    },
    {
      ...
      title: "Защитные меры",
      tables: [],
      note: ["При экспорте защитные меры не применяются."],
    },
    {
      id: "preferences",
      title: "Тарифные преференции",
      tables: [],
      note: [
        "Преференции применяются на рынке страны назначения — см. «Международный рынок и тарифы».",
      ],
    },
    {
      id: "vat",
    ...
    },
    {
      ...
      tables: [
        {
          columns: ["№", "Ставка", "Нормативно-правовой акт", "Описание", "Действует с", "Действует до"],
          rows: [["1", "Не облагается", L("Кодекс Республики Казахстан № 120-VI ЗРК"), "Возможен возврат акциза при экспорте", "25.12.2017", "—"]],
        },
      ],
      note: ["Возврат акциза производится при подтверждённом вывозе подакцизного товара."],
    },
    {
      id: "restrictions",
      title: "Запреты и ограничения",
    ...
    },
    {
      ...
      tables: [
        {
          columns: ["№", "Наименование", "Нормативно-правовой акт", "Действует с", "Действует до"],
          rows: [["1", "Возврат НДС при подтверждённом экспорте", L("Кодекс Республики Казахстан № 120-VI ЗРК"), "01.01.2018", "—"]],
        },
      ],
      note: ["Льгота применяется при наличии полного пакета подтверждающих документов."],
    },
    {
      id: "marking",
      title: "Маркировка",
      tables: [
        {
          columns: ["№", "Вид", "Нормативно-правовой акт", "Действует с", "Действует до"],
          rows: [["1", "Маркировка по требованиям страны назначения", L("Регламенты страны импорта"), "—", "—"]],
        },
      ],
      note: ["Требования к маркировке определяются законодательством страны назначения."],
    },
  ];
}
